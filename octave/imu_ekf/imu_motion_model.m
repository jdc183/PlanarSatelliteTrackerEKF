...
%  mu += B*u;
  ...
  G = [1, 0,-0.5*dt^2*(ax*sin(theta_prev)+ay*cos(theta_prev)), dt,  0;
       0, 1, 0.5*dt^2*(ax*cos(theta_prev)-ay*sin(theta_prev)),  0, dt;
       0, 0, 1,                                                 0,  0;
       0, 0,-dt*(ax*sin(theta_prev)+ay*cos(theta_prev)),        1,  0;
       0, 0, dt*(ax*cos(theta_prev)-ay*sin(theta_prev)),        0,  1];
